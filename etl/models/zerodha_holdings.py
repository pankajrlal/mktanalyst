...
def zerodha_holdings(context, **kwargs)-> pd.DataFrame:
    """
    Extract the current holdings from "seeds/zerodha/holdings_YYYYMMDD.csv" 
    ...
    # Scan the files in the seeds/zerodha directory 
